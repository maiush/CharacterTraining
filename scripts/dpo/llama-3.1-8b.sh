...
openrlhf.cli.train_dpo \
    ...
    --learning_rate 5e-7 \
    --max_epochs 5 \
    --pretrain /root/mats/CharacterTraining/saves/sft/llama-3.1-8b \
    --dataset /root/mats/CharacterTraining/data/dpo/llama-3.1-8b.jsonl \
    --chosen_key chosen \
    ...
    --wandb_run_name llama-3.1-8b-dpo
EOF
