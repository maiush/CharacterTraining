...
openrlhf.cli.train_sft \
    --save_path /workspace/gemma-2-9b-blended-heavy-evaluator \
    --eval_steps 50 \
    --max_ckpt_num 1 \
    ...
    --bf16 \
    --max_epochs 1 \
    --pretrain maius/gemma-2-9b-blended-heavy \
    --learning_rate 5e-6 \
    --lora_rank 32 \
    --lora_alpha 16 \
    ...
    --wandb_run_name evaluator-gemma-2-9b-blended-heavy
EOF
...
if [ $? -eq 0 ]; then
    ...
    python upload_model.py --model gemma-2-9b-blended-heavy-evaluator
